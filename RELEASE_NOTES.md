# Release Notes\n\n- Added Forge Cursor Reveal Engine with lens, persistent trail and GPU-fluid reveal modes, centralized pointer/touch/pressure input, linger/fade brush persistence, Studio authoring, Canvas fallback and projected WebGL fluid simulation.\n- Added Advanced → Visual effects to the current Build / Review / Ship Studio so cinematic cursor effects remain specialist controls instead of permanent navigation.\n\n- Added Forge Creative Intelligence 2.0: project-specific Creative DNA, deterministic Art Director, three divergent visual-language worlds, ten-dimension territory-distance gates, Creative Mutation, eight specialist creative directors and a 13-dimension Creative Ceiling V2.
...
- Added Forge Director immersive construction intelligence with 236 evidence-graded references, 108 executable construction patterns, 25 primary technical doctrine groups and 18 evidence-backed failure lessons.
