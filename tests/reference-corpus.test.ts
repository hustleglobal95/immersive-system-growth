...
test("broader immersive corpus adds 187 public studio and technical/source studies", () => {
  ...
  assert.equal(immersiveReferenceCorpus.length, 236);
});
