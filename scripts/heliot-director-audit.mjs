...
if (report.verdict === "REJECT") throw new Error(`HELIOT Director rejected the current direction: ${report.blockers.join(" | ")}`);
...
console.log(`HELIOT Director verdict: ${report.verdict}`);
