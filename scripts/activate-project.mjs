...
for (const name of ["experience.json", "studio-project.json"]) {
...
fs.writeFileSync("config/studio-project.json", JSON.stringify({ ...project, experiencePath: "config/experience.json" }, null, 2) + "\n");
