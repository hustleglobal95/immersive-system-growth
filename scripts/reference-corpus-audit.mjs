...
if (immersiveReferenceCorpus.length < 100) {
  errors.push(`Expected at least 100 references; found ${immersiveReferenceCorpus.length}.`);
}
if (immersiveConstructionPatterns.length < 52) {
  errors.push(`Expected at least 52 construction patterns; found ${immersiveConstructionPatterns.length}.`);
}
