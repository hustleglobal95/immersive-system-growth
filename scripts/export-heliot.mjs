...
fs.writeFileSync(`${output}/index.html`, '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>HELIOT — Observatory for the unseen</title><meta http-equiv="refresh" content="0;url=/heliot"></head><body style="background:#151719;color:#e8e4dc;font:20px sans-serif;padding:10vw"><a style="color:inherit" href="/heliot">Enter HELIOT — Observatory for the unseen</a></body></html>');
