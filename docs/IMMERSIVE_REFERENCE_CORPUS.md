...
This corpus exists to make Forge better at **constructing** premium immersive websites with its existing engine. It is not a mirror of GetLayers, a prompt dump, or a source-code archive.\n\nThe GetLayers set remains one visual corpus inside a broader research system. The combined Director research pool now contains **170 references** across GetLayers, Dogstudio, Lusion, makemepulse, Bonhomme, 14islands and Codrops technical case studies, feeding **92 reusable construction patterns**.
