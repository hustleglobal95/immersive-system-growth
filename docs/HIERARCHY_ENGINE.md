...
The report is attached to `runDirectorIntelligence(...).report.hierarchy`, so Director, Creative Agent and future Studio surfaces can consume one shared hierarchy model.
