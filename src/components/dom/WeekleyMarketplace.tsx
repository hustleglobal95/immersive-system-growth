...
export function WeekleyMarketplace() {
  ...
  return <main className="dw-site" ref={site} id="top">
    ...
    <div id="main-content">
      ...
      <section className="dw-life" id="life" aria-label="Life at Waterset"><ParallaxLayer className="dw-life__image" speed={0.32} distance={180}><img src="/assets/weekley/neighborhood.webp" alt="Aerial view of the pools, lake and community spaces at Waterset in Apollo Beach" width="1800" height="1200" loading="lazy" /></ParallaxLayer><div className="dw-life__wash" /><div className="dw-life__content"><p className="dw-eyebrow">BEYOND YOUR FRONT DOOR</p><h2 className="dw-life__title">Home is more<br />than a house.</h2><div className="dw-life__bottom"><p>Room to roam. Places to gather.<br />Discover life at Waterset, Apollo Beach.</p><button className="dw-button dw-button--white" onClick={() => setOverlay({ kind: "community", id: "waterset" })}>Explore the neighborhood <Icon name="arrow" /></button></div></div><span className="dw-life__credit">WATERSET · APOLLO BEACH, FLORIDA</span></section>
