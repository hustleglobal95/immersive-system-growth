...
export function LabGuides(){const lines=useMemo(()=>experience.scenes.map(s=>Array.from({length:33},(_,i)=>sampleExperience(s.range[0]+(s.range[1]-s.range[0])*i/32,false).camera.position)),[]);
