...
export const studioProjectSchema = z
  .object({
    ...
    directorEvidencePath: relativeJsonPath.default("config/director/evidence.json"),
    directorDecisionsPath: relativeJsonPath.default("config/director/decisions.json"),
    directorFingerprintPath: relativeJsonPath.default("config/director/fingerprint.json"),
    directorCritiquePath: relativeJsonPath.default("config/director/critique.json"),
    directorReviewHistoryPath: relativeJsonPath.default("config/director/review-history.json"),
