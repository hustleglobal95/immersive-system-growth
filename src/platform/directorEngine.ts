...
const profiles: Record<DirectorBrief["projectType"], ProjectProfile> = {
  ...
  campaign: {
    ...
    experiencePremises: ["Setup → tension → participation → reveal → response → action.", "Keep the experience short enough that intensity never becomes fatigue.", "End while the central idea still feels fresh."],
    ...
    arc: [["Setup", "curiosity", 5], ["Tension", "anticipation", 7], ["Participation", "engagement", 6], ["Reveal", "awe", 10], ["Response", "meaning", 5], ["Action", "intent", 5]],
